...
sgx_status_t train_logistic_regression1(sgx_enclave_id_t eid, unsigned char* data, float lr, int iter, unsigned int data_rows, unsigned int data_cols, unsigned int data_len, float* weights);
